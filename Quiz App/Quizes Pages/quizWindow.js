...
// function cssQuizHere(){
//     function renderQuestion() {
//         question.innerHTML = CssQuiz[questionCounter].question
    
//         label1.innerHTML = CssQuiz[questionCounter].option1
//         label2.innerHTML = CssQuiz[questionCounter].option2
//         label3.innerHTML = CssQuiz[questionCounter].option3
//         label4.innerHTML = CssQuiz[questionCounter].option4
    
//         option1.value = CssQuiz[questionCounter].option1;
//         option2.value = CssQuiz[questionCounter].option2;
//         option3.value = CssQuiz[questionCounter].option3;
//         option4.value = CssQuiz[questionCounter].option4;
...
//                 isRadioChecked = true
//                 console.log(quizOptions[i].value);
//                 if(quizOptions[i].value == CssQuiz[questionCounter].answer){
//                     score++
//                 }
//             } 
//         }
...
//         questionContainer.style.display = "none";
//         resultWindow.classList.remove('show-result-screen')
//         let per = Math.round(score / CssQuiz.length * 100);
...
//             percentageShow.classList.add('green-per')
//         }
//         totalQues.textContent = CssQuiz.length;
//         correctQues.textContent = score;
//         wrongAns.textContent = CssQuiz.length - score;
//         percentageShow.textContent = `${per}%`;

//         goHome.addEventListener('click',function(){
//         location.assign('cssQuiz.html');
//         resultWindow.classList.add('show-result-screen')
//         })
//     }
//     renderQuestion();
...
// function jsQuizHere(){
//     function renderQuestion() {
//         question.innerHTML = jsQuiz[questionCounter].question
    
//         label1.innerHTML = jsQuiz[questionCounter].option1
//         label2.innerHTML = jsQuiz[questionCounter].option2
//         label3.innerHTML = jsQuiz[questionCounter].option3
//         label4.innerHTML = jsQuiz[questionCounter].option4
    
//         option1.value = jsQuiz[questionCounter].option1;
//         option2.value = jsQuiz[questionCounter].option2;
//         option3.value = jsQuiz[questionCounter].option3;
//         option4.value = jsQuiz[questionCounter].option4;
...
//                 isRadioChecked = true
//                 console.log(quizOptions[i].value);
//                 if(quizOptions[i].value == jsQuiz[questionCounter].answer){
//                     score++
//                 }
//             } 
//         }
...
//               });
//         }else {
//             if (questionCounter < jsQuiz.length - 1) {
//                 questionCounter++
//                 renderQuestion();
//                 disSeletOption();
//             }else{
...
//         questionContainer.style.display = "none";
//         resultWindow.classList.remove('show-result-screen')
//         let per = Math.round(score / jsQuiz.length * 100);
...
//             percentageShow.classList.add('green-per')
//         }
//         totalQues.textContent = jsQuiz.length;
//         correctQues.textContent = score;
//         wrongAns.textContent = jsQuiz.length - score;
//         percentageShow.textContent = `${per}%`;

//         goHome.addEventListener('click',function(){
//         location.assign('jsQuiz.html');
//         resultWindow.classList.add('show-result-screen')
//         })
//     }
//     renderQuestion();
...
// if(getquizName == "Html"){
//     window.onload = htmlQuizHere();
// }
//  else if(getquizName == "Css"){
//     window.onload = cssQuizHere()
// }
// else if(getquizName == "JavaScript"){
//     window.onload = jsQuizHere()
// }